...
Try
  ...
  Dim query as String="select *from u_relfonte join  u_fontedados on u_fontedados.u_fontedadosstamp=u_relfonte.fontestamp where u_relfonte.syncstamp=@syncstamp"
