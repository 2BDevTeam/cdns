...
Try
    ...
    Dim queryMdashFonte="select MDashFonte.* from MDashFonte join u_mdash on u_mdash.u_mdashstamp=MDashFonte.dashboardstamp where u_mdash.codigo=@codigo order by MDashFonte.ordem asc"
