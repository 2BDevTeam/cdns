Try
   ...
   ' scriptJs +="<script src='https://cdn.jsdelivr.net/gh/2BDevTeam/cdns@master/GLOBAL.js'></script>"   
    ...
    scriptJs+="<script src='https://cdn.jsdelivr.net/npm/handlebars@4.7.8/dist/handlebars.min.js'></script>"
    ...
    scriptJs+="<script src='https://cdnjs.cloudflare.com/ajax/libs/sql.js/0.3.2/js/sql.js'></script>"
